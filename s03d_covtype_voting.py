...
OUTPUT_DIR = Path('/kaggle/working/voting_results')
...
et_params = tuned['extra_trees']['params']
...
checkpoint_file = CHECKPOINT_DIR / 'voting_progress.json'
results_file = CHECKPOINT_DIR / 'voting_results_intermediate.csv'
...
results_df.to_csv(OUTPUT_DIR / 'voting_results_full.csv', index=False)
...
summary.to_csv(OUTPUT_DIR / 'voting_summary.csv', index=False)
...
per_class_summary.to_csv(OUTPUT_DIR / 'voting_per_class_metrics.csv', index=False)
...
nsi_df.to_csv(OUTPUT_DIR / 'voting_nsi.csv', index=False)
...
pd.DataFrame([test_result_record]).to_csv(OUTPUT_DIR / 'voting_test_results.csv', index=False)
