...
OUTPUT_DIR = Path('/kaggle/working/xgb_results')
...
checkpoint_file = CHECKPOINT_DIR / 'xgb_progress.json'
results_file = CHECKPOINT_DIR / 'xgb_results_intermediate.csv'
...
results_df.to_csv(OUTPUT_DIR / 'xgb_results_full.csv', index=False)
...
summary.to_csv(OUTPUT_DIR / 'xgb_summary.csv', index=False)
...
per_class_summary.to_csv(OUTPUT_DIR / 'xgb_per_class_metrics.csv', index=False)
...
nsi_df.to_csv(OUTPUT_DIR / 'xgb_nsi.csv', index=False)
...
pd.DataFrame([test_result_record]).to_csv(OUTPUT_DIR / 'xgb_test_results.csv', index=False)
