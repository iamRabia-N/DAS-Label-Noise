...
OUTPUT_DIR = Path('/kaggle/working/stacking_symmetric_results')
...
checkpoint_file = CHECKPOINT_DIR / 'stacking_symmetric_progress.json'
results_file = CHECKPOINT_DIR / 'stacking_symmetric_results_intermediate.csv'
...
results_df.to_csv(OUTPUT_DIR / 'stacking_symmetric_results_full.csv', index=False)
...
summary.to_csv(OUTPUT_DIR / 'stacking_symmetric_summary.csv', index=False)
...
per_class_summary.to_csv(OUTPUT_DIR / 'stacking_symmetric_per_class_metrics.csv', index=False)

subset = summary[summary['noise_type'] == 'symmetric'].sort_values('noise_level')
...
pd.DataFrame([nsi_record]).to_csv(OUTPUT_DIR / 'stacking_symmetric_nsi.csv', index=False)
