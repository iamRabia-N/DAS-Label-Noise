...
assert _hits, "attach the s11 output (new_image_features)"
...
RF_EMBEDDED = {'best_params': {'max_depth': None, 'max_features': 'sqrt', 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 300}, 'best_cv_score': 0.8241, 'tuning_time_minutes': 86.9, 'note': 'completed in 13b run of 2026-08-13, values from its log'}
